...
- **Team:** Solo project
- **My Role:** I cleaned and joined the data, built the data pipelines allowing for reporducability, created features, trained XGBoost models, analyzed result with SHAP, and created visualizations.
